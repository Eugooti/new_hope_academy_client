...
export default function AnotherSchoolModal({handleYes,open,setOpen}) {
                                        ...
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-gray-700">
                                                    You are about to transfer a learner to another school.
                                                </p>
                                                <p className="text-sm text-gray-700">
                                                    This operation will permanently remove the learner records from the school database.
                                                </p>
